...
import "./rythubandhusamithi.css";


const RythuBandhuSamithi = () => {
  const images = [
    {
      id: 1,
      title: "Beach Sunset",
  ...
  return (
    <div className="gallery-container">
      <h1 className="gallery-title">Memories | Project RYTHU BANDHU SAMITHI</h1>
...
export default RythuBandhuSamithi;
